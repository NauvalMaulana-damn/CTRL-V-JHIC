<div x-data="{ open: false }" class="fixed top-1/2 right-4 transform -translate-y-1/2 z-50">
    ...
    <!-- Tambahin CSS biar sidebar gak nongol sebelum Alpine jalan -->
    <style>
    [x-cloak] {
    ...
    <!-- Toggle Button -->
    <button @click="open = !open" class="flex  absolute -left-10 top-1/2 transform -translate-y-1/2 bg-white/30 backdrop-blur-md
