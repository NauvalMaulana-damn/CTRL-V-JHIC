...
<head>
    ...
    <title>Glass Effect Sidebar</title>
...
<body>
    ...
    <!-- Sidebar Component -->
    <div class="sidebar glass-effect w-[325px] h-[763px] rounded-2xl flex flex-col justify-between z-50 relative overflow-hidden">
        <!-- Decorative elements -->
        ...
        <div class="p-5 bg-gray-50/70 rounded-t-2xl relative z-10">
            ...
            <button class="see-more-btn w-full mt-4 bg-dark text-white py-2 rounded-lg font-semibold flex items-center justify-center">
                Selengkapnya
