    ...
    <main class="w-full lg:w-3/4 animate-fade-in">
        ...
        <section class="py-6 md:py-10 animate-fade-in delay-200">
            ...
            <div class="flex flex-col lg:flex-row gap-6">
                ...
                <div class="w-full lg:w-1/2 department-card bg-customPink p-5 md:p-6 relative overflow-hidden">
                    <div class="info-card bg-white p-2 mb-5 md:mb-6">
                        <img width="100%" height="100%" class="w-full object-cover max-h-72 rounded-2xl object-[center_20%]"
        ...
        <section class="bg-gray-200 py-12 rounded-xl mt-8 animate-fade-in delay-300">
            <div class="container mx-auto px-4">
                <h2 class="text-2xl md:text-4xl lg:text-5xl font-bold text-center mb-8 md:mb-12">TIGA KEBIASAAN MURID
                    SKARIGA</h2>
                <div class="flex flex-col lg:flex-row items-center gap-6 justify-center">
                    <!-- Habit 1 -->
                    <div
                        class="w-full lg:w-1/3 habit-card text-white bg-customBlue p-5 flex overflow-hidden flex-col rounded-xl transition-transform duration-300 hover:scale-105 hover:shadow-xl">
                    ...
                    <div
                        class="w-full lg:w-2/5 habit-card text-white bg-customOrange p-6 flex overflow-hidden flex-col rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-2xl z-10 min-h-[520px]">
