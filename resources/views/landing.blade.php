        ...
        <main class="w-full lg:w-3/4">
            ...
            <section class="bg-gray-200 py-12 rounded-xl mt-8 animate-fade-in delay-300">
                <div class="container mx-auto px-4">
                    <h2 class="text-2xl md:text-4xl lg:text-5xl font-bold text-center mb-8 md:mb-12">3 KEBIASAAN MURID SKARIGA</h2>
            ...
            <div class="flex flex-col md:flex-row gap-8 justify-between">
                ...
                <div class="w-full md:w-1/4">
                    ...
                    <div class="flex space-x-4 mb-6">
                        <a href="#"
                            class="w-10 h-10 bg-gray-700 rounded-full flex items-center justify-center hover:bg-customRed transition">
