...
<div class="bg-white text-gray-900 font-sans">
  ...
  <!-- Hero Section -->
  <section class="relative h-80 md:h-96 bg-cover bg-center rounded-xl mx-4 md:mx-6 mt-6" style="background-image: url('https://images.unsplash.com/photo-1581091012184-1b6fdd48cb43?auto=format&fit=crop&w=1050&q=80')">
  ...
  <div class="min-w-[300px] shrink-0 bg-white rounded-lg shadow p-4 snap-start">
    <img src="https://images.unsplash.com/photo-1607082341738-6c30e29f92d8?auto=format&fit=crop&w=400&q=80" class="h-40 w-full object-cover rounded mb-2" />
    <h4 class="font-semibold mb-1">Teknik Elektronika & Audio Video</h4>
    <p class="text-sm text-gray-700">Jurusan AV ...</p>
  </div>
  <div class="min-w-[300px] shrink-0 bg-white rounded-lg shadow p-4 snap-start">
    <img src="https://images.unsplash.com/photo-1596495577886-d920f1e0eee7?auto=format&fit=crop&w=400&q=80" class="h-40 w-full object-cover rounded mb-2" />
    <h4 class="font-semibold mb-1">Teknik Elektronika Industri</h4>
    <p class="text-sm text-gray-700">Jurusan EI ...</p>
  </div>
  <div class="min-w-[300px] shrink-0 bg-white rounded-lg shadow p-4 snap-start">
    <img src="https://images.unsplash.com/photo-1581090700227-ba320415b4d1?auto=format&fit=crop&w=400&q=80" class="h-40 w-full object-cover rounded mb-2" />
  ...
  <section id="otomotif" class="mt-20 max-w-7xl mx-auto px-4 md:px-6">
    ...
    <div class="slider-container">
      <div class="slider flex space-x-6 overflow-x-auto pb-4 scrollbar-thumb-blue-500 scrollbar-track-gray-200">
        <div class="min-w-[300px] bg-white rounded-lg shadow p-4 shrink-0 jurusan-card">
          <img src="https://images.unsplash.com/photo-1525609004556-c46c7d6cf023?auto=format&fit=crop&w=400&q=80" alt="Teknik Bisnis Sepedah Motor" class="rounded mb-2 h-40 w-full object-cover" />
          <h4 class="font-semibold mb-1">Teknik Bisnis Sepedah Motor</h4>
          <p class="text-sm text-gray-700">Jurusan TSM mempelajari perbaikan, penjualan bisnis sepedah motor...</p>
        </div>

        <div class="min-w-[300px] bg-white rounded-lg shadow p-4 shrink-0 jurusan-card">
          <img src="https://images.unsplash.com/photo-1519838262952-6a95d8a18c7d?auto=format&fit=crop&w=400&q=80" alt="Teknik Kendaraan Ringan" class="rounded mb-2 h-40 w-full object-cover" />
          <h4 class="font-semibold mb-1">Teknik Kendaraan Ringan</h4>
          <p class="text-sm text-gray-700">Jurusan TKR, mempelajari perawatan kendaraan ringan dan mekanik...</p>
        </div>

        <div class="min-w-[300px] bg-white rounded-lg shadow p-4 shrink-0 jurusan-card">
          <img src="https://images.unsplash.com/photo-1562079337-529deee94394?auto=format&fit=crop&w=400&q=80" alt="Teknik Perbaikan Body Otomotif" class="rounded mb-2 h-40 w-full object-cover" />
          <h4 class="font-semibold mb-1">Teknik Perbaikan Body Otomotif</h4>
          <p class="text-sm text-gray-700">Jurusan BPO mempelajari perbaikan body dan pengecatan kendaraan...</p>
        </div>

        <!-- Tambahan kartu untuk demo slider -->
        <div class="min-w-[300px] bg-white rounded-lg shadow p-4 shrink-0 jurusan-card">
          <img src="https://images.unsplash.com/photo-1549317661-bd32c8ce0db2?auto=format&fit=crop&w=400&q=80" alt="Teknik Ototronik" class="rounded mb-2 h-40 w-full object-cover" />
          <h4 class="font-semibold mb-1">Teknik Ototronik</h4>
          <p class="text-sm text-gray-700">Jurusan ototronik, mempelajari sistem elektronik pada kendaraan modern...</p>
        </div>
      </div>
  ...
  <section id="pemesinan" class="mt-20 max-w-7xl mx-auto px-4 md:px-6">
    ...
    <div class="slider-container">
      <div class="slider flex space-x-6 overflow-x-auto pb-4 scrollbar-thumb-blue-500 scrollbar-track-gray-200">
        <div class="min-w-[300px] bg-white rounded-lg shadow p-4 shrink-0 jurusan-card">
          <img src="https://images.unsplash.com/photo-1522202176988-66273c2fd55f?auto=format&fit=crop&w=400&q=80" alt="Bisnis Digital & Pemasaran" class="rounded mb-2 h-40 w-full object-cover" />
          <h4 class="font-semibold mb-1">Bisnis Digital & Pemasaran</h4>
          <p class="text-sm text-gray-700">Jurusan BDP mempelajari pemasaran elektronik dan bisnis digital...</p>
        </div>

        <div class="min-w-[300px] bg-white rounded-lg shadow p-4 shrink-0 jurusan-card">
          <img src="https://images.unsplash.com/photo-1519389950473-47ba0277781c?auto=format&fit=crop&w=400&q=80" alt="Teknik Pengelasan" class="rounded mb-2 h-40 w-full object-cover" />
        ...
        <div class="min-w-[300px] bg-white rounded-lg shadow p-4 shrink-0 jurusan-card">
          <img src="https://images.unsplash.com/photo-1581093588401-9a4a4950bc34?auto=format&fit=crop&w=400&q=80" alt="Teknik Pemesinan" class="rounded mb-2 h-40 w-full object-cover" />
          <h4 class="font-semibold mb-1">Teknik Pemesinan</h4>
          <p class="text-sm text-gray-700">Jurusan TM mempelajari proses pembuatan mesin dan komponennya...</p>
        </div>

        <!-- Tambahan kartu untuk demo slider -->
        <div class="min-w-[300px] bg-white rounded-lg shadow p-4 shrink-0 jurusan-card">
          <img src="https://images.unsplash.com/photo-1581094794329-c8112a89af12?auto=format&fit=crop&w=400&q=80" alt="Teknik Fabrikasi Logam" class="rounded mb-2 h-40 w-full object-cover" />
          <h4 class="font-semibold mb-1">Teknik Fabrikasi Logam</h4>
          <p class="text-sm text-gray-700">Jurusan fabrikasi, mempelajari pembuatan struktur logam dan komponen...</p>
        </div>
      </div>
      <div class="slider-nav">
  ...
  <section id="tik" class="mt-20 max-w-7xl mx-auto px-4 md:px-6 mb-16">
    ...
    <div class="slider-container">
      <div class="slider flex space-x-6 overflow-x-auto pb-4 scrollbar-thumb-blue-500 scrollbar-track-gray-200">
        <div class="min-w-[300px] bg-white rounded-lg shadow p-4 shrink-0 jurusan-card">
          <img src="https://images.unsplash.com/photo-1504384308090-c894fdcc538d?auto=format&fit=crop&w=400&q=80" alt="Animasi" class="rounded mb-2 h-40 w-full object-cover" />
          <h4 class="font-semibold mb-1 text-purple-600">Animasi</h4>
          <p class="text-sm text-gray-700">Jurusan NIM mempelajari animasi, ilustrator, storyboard, dsb.</p>
        </div>

        <div class="min-w-[300px] bg-white rounded-lg shadow p-4 shrink-0 jurusan-card">
          <img src="https://images.unsplash.com/photo-1508672019048-805c876b67e2?auto=format&fit=crop&w=400&q=80" alt="Desain Komunikasi Visual" class="rounded mb-2 h-40 w-full object-cover" />
        ...
        <div class="min-w-[300px] bg-white rounded-lg shadow p-4 shrink-0 jurusan-card">
          <img src="https://images.unsplash.com/photo-1523050854058-8df90110c9f1?auto=format&fit=crop&w=400&q=80" alt="Broadcasting & Perfilman" class="rounded mb-2 h-40 w-full object-cover" />
          <h4 class="font-semibold mb-1 text-purple-600">Broadcasting & Perfilman</h4>
          <p class="text-sm text-gray-700">Jurusan Broadcasting mempelajari produksi media dan perfilman...</p>
        </div>

        <!-- Tambahan kartu untuk demo slider -->
        <div class="min-w-[300px] bg-white rounded-lg shadow p-4 shrink-0 jurusan-card">
          <img src="https://images.unsplash.com/photo-1555066931-4365d14bab8c?auto=format&fit=crop&w=400&q=80" alt="Rekayasa Perangkat Lunak" class="rounded mb-2 h-40 w-full object-cover" />
          <h4 class="font-semibold mb-1 text-purple-600">Rekayasa Perangkat Lunak</h4>
          <p class="text-sm text-gray-700">Jurusan RPL mempelajari pengembangan aplikasi dan software...</p>
        </div>
      </div>
      <div class="slider-nav">
