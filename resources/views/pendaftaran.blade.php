    ...
    <div class="bg-white text-gray-800">
        ...
        <section class="relative h-[60vh] bg-black">
            <img src="https://images.unsplash.com/photo-1509062522246-3755977927d7?auto=format&fit=crop&w=1600&q=80"
                alt="Hero" class="absolute inset-0 w-full h-full object-cover opacity-80">
            ...
            <div class="relative h-full flex flex-col justify-center items-center text-center text-white px-4">
                ...
                <div class="flex gap-4 mt-2">
                    <button
                        class="bg-white text-black px-5 py-2 rounded-full font-medium hover:bg-gray-100 transition">&lt;
                        OFFLINE</button>
                    <button
                        class="bg-customOrange bg-orange-500 text-white px-5 py-2 rounded-full font-medium hover:bg-orange-600 transition">ONLINE
                        &gt;</button>
                </div>
            </div>
        </section>
            ...
            <div class="max-w-7xl mx-auto px-4">
                ...
                <div class="relative overflow-x-auto">
                    <div class="min-w-[1000px] relative">
                        ...
                        <svg class="absolute top-0 left-0 w-full h-72" viewBox="0 0 1000 280" fill="none"
                            preserveAspectRatio="none">
                            <path d="M 50 200 Q 250 50, 500 160 Q 750 260, 950 120" stroke="url(#orangeGradient)"
                                stroke-width="10" fill="transparent" />
                            <defs>
                                <linearGradient id="orangeGradient" x1="0" y1="0" x2="1000" y2="0"
                        ...
                        <div class="absolute top-0 left-0 w-full h-72 flex justify-between px-10">
                            ...
                            <div class="flex flex-col items-center mt-[180px]">
                                <div
                                    class="bg-orange-500 text-white w-14 h-14 flex items-center justify-center rounded-full font-bold shadow-lg mb-2">
                                    1
                                </div>
            ...
            <div class="max-w-4xl mx-auto bg-orange-500 rounded-3xl p-8 flex flex-col gap-8">
                ...
                <div class="flex flex-col md:flex-row items-center justify-between text-white gap-6 relative">
                    ...
                    <div class="flex flex-col items-center text-center">
                        <div
                            class="bg-white text-orange-500 font-bold w-10 h-10 rounded-full flex items-center justify-center mb-2">
                            1</div>
                    ...
                    <div class="flex flex-col items-center text-center">
                        <div
                            class="bg-white text-orange-500 font-bold w-10 h-10 rounded-full flex items-center justify-center mb-2">
                            2</div>
                        <img src="https://cdn-icons-png.flaticon.com/512/2584/2584604.png" class="w-12 mb-2"
                            alt="Salam">
                    ...
                    <div class="flex flex-col items-center text-center">
                        <div
                            class="bg-white text-orange-500 font-bold w-10 h-10 rounded-full flex items-center justify-center mb-2">
                            3</div>
                        <img src="https://cdn-icons-png.flaticon.com/512/1057/1057097.png" class="w-12 mb-2"
                            alt="Staff">
