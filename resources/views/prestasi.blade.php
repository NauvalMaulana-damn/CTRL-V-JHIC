    ...
    <div class="bg-gray-50 font-sans text-gray-900 relative overflow-hidden">
        ...
        <section class="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-2 gap-10 relative z-10">
            <div class="flex flex-col justify-center space-y-6">
                <div class="flex items-center gap-3 mb-4">
                    <img src="{{ asset('assets/trophy.png') }}" class="w-10 h-10 drop-shadow-md animate-bounce"
                        alt="Trophy">
                    <h2
            ...
            <div class="grid grid-cols-2 gap-4 relative">
                ...
                <img src="{{ asset('assets/skariga pres.jpeg') }}"
                    class="rounded-lg shadow-md w-full aspect-[4/3] object-cover transition-transform duration-300 hover:scale-105 hover:brightness-105"
                    alt="Juara Seleksi Nasional 2024" />
                <!-- Kanan (foto tinggi) -->
                ...
                <img src="{{ asset('assets/skariga prestasi.jpg') }}"
                    class="rounded-lg shadow-md w-full aspect-[4/3] object-cover transition-transform duration-300 hover:scale-105 hover:brightness-105"
                    alt="Juara Car Painting" />
        </section>
        ...
        <section class="max-w-6xl mx-auto px-4 py-8">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
                <div
                    class="bg-white rounded-xl p-6 text-center shadow-md transition-transform duration-300 hover:-translate-y-1">
