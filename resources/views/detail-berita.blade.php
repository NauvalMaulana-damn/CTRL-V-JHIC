<x-layout title="{{ $berita->title }} - SMK PGRI 3 Malang">
    <div class="bg-gray-50">
        <!-- Header Statis -->
        <section class="bg-gradient-to-r from-customBlue to-blue-800 text-white py-12 mt-[-8rem]">
            <div class="container mx-auto px-4">
                <div class="max-w-3xl">
                    <h1 class="text-4xl font-bold mb-4">{{ $berita->title }}</h1>
                    <p class="text-lg mb-6">{{ Str::limit($berita->deskripsi, 150) }}</p>
            ...
            <div class="flex flex-col lg:flex-row gap-8">
                    ...
                    <div class="bg-white rounded-xl shadow-md overflow-hidden">
                        ...
                        <div class="p-8">
                            ...
                            <div class="mt-8 pt-6 border-t border-gray-200">
                                <div class="flex space-x-4">
                                    <button class="bg-customBlue hover:bg-blue-800 text-white px-4 py-2 rounded-lg font-medium transition-colors">
                ...
                <div class="w-full lg:w-1/4">
                    ...
                    <div class="bg-white p-5 rounded-xl shadow-md mb-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-start space-x-3 pb-4 border-b border-gray-100 last:border-b-0">
                                <img src="{{ $item->gambar_url }}" alt="{{ $item->title }}" class="w-16 h-16 object-cover rounded-lg">
                                <div>
                                    <a href="{{ route('berita.show', $item->slug) }}" class="font-medium text-sm hover:text-customBlue transition-colors line-clamp-2">
                                        {{ $item->title }}
                                    </a>
                    ...
                    <div class="bg-white p-5 rounded-xl shadow-md">
                        ...
                        <ul class="space-y-3">
                            <li>
                                <a href="http://117.102.78.163/student/" class="text-blue-600 hover:underline flex items-center">
                                    <i class="fas fa-link mr-2 text-sm"></i>OCS (One Click Service)
                                </a>
                            </li>
                            <li>
                                <a href="http://117.102.78.163/ocscbt/" class="text-blue-600 hover:underline flex items-center">
                                    <i class="fas fa-link mr-2 text-sm"></i>CBT (Computer Based Test)
                                </a>
                            </li>
                            <li>
                                <a href="https://bki-skariga.web.id/kerjasama-industri/" class="text-blue-600 hover:underline flex items-center">
                                    <i class="fas fa-link mr-2 text-sm"></i>Bidang Kerja Sama Industri
                                </a>
                            </li>
                            <li>
                                <a href="http://117.102.78.163/portalakademik/" class="text-blue-600 hover:underline flex items-center">
