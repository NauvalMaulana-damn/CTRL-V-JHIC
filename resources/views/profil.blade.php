<x-layout title="SMK PGRI 3 MALANG - Success by Discipline" :headerTransparent="true">
    ...
    <body class="bg-gray-50 text-gray-800">
            ...
            <div class="grid md:grid-cols-2 gap-10 items-start">
                ...
                <div class="grid gap-4">
                    ...
                    <img src="{{ asset('assets/gedung-seluruh.jpg') }}"
                        class="rounded-x4 shadow-md w-full h-64 object-cover hover-scale hover-brightness" alt="Gedung Seluruhs">

                    <!-- 3 gambar kecil di bawah -->
                    <div class="grid grid-cols-2 gap-4">
                        <img src="{{ asset('assets/foto-depanadmin.JPG') }}"
                            class="rounded-xl shadow-md h-40 w-full object-cover hover-scale hover-brightness" alt="Gedung 1">
                        <img src="{{ asset('assets/depan-alfa.webp') }}"
                            class="rounded-xl shadow-md h-40 w-full object-cover hover-scale hover-brightness" alt="Gedung 2">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="grid md:grid-cols-2 gap-6">
                        <!-- Box 1 -->
                        <div>
                            <div class="flex items-center gap-2 bg-orange-500 text-white rounded-lg px-4 py-3 shadow hover-lift hover-glow">
        ...
        <section class="max-w-6xl mx-auto px-4 pt-6 pb-10">
            <div class="bg-orange-500 rounded-2xl shadow-lg overflow-hidden hover-lift">
                <div class="grid md:grid-cols-2 gap-6 items-center">
                    ...
                    <img src="{{ asset('assets/kcs-manjat.png') }}" alt="Visi" class="w-full h-full object-cover hover-scale">
                </div>
            </div>
        </section>
        ...
        <section class="max-w-6xl mx-auto px-4 pt-6 pb-10">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
                ...
                <!-- Card 1 -->
                <div class="bg-blue-500 text-white rounded-xl shadow-lg text-center p-8 flex flex-col items-center hover-lift hover-rotate">
                ...
                <!-- Card 2 -->
                <div class="bg-green-500 text-white rounded-xl shadow-lg text-center p-8 flex flex-col items-center hover-lift hover-rotate">
                ...
                <!-- Card 3 -->
                <div class="bg-orange-500 text-white rounded-xl shadow-lg text-center p-8 flex flex-col items-center hover-lift hover-rotate">
                ...
                <!-- Card 4 -->
                <div class="bg-red-500 text-white rounded-xl shadow-lg text-center p-8 flex flex-col items-center hover-lift hover-rotate">
        ...
        <div class="py-4 overflow-hidden rounded-lg mb-8 animate-fade-in delay-100">
            <div class="scroll-container flex whitespace-nowrap animate-scroll">
                <div class="flex space-x-8 md:space-x-12 pr-12">
                    <!-- Logo asli -->
                    <img class="h-6 md:h-10 object-contain inline-block hover-scale" src="{{ asset('assets/alfa logo 1.png') }}"
                        alt="Partner Logo">
                    <img class="h-6 md:h-10 object-contain inline-block hover-scale" src="{{ asset('assets/b&d icon 1.png') }}"
                        alt="Partner Logo">
                    <img class="h-6 md:h-10 object-contain inline-block hover-scale" src="{{ asset('assets/lg icon 1.png') }}"
                        alt="Partner Logo">
                    <img class="h-6 md:h-10 object-contain inline-block hover-scale" src="{{ asset('assets/pjb icon 1.png') }}"
                        alt="Partner Logo">
                    <img class="h-6 md:h-10 object-contain inline-block hover-scale"
                        src="{{ asset('assets/daihat logo 1.png') }}" alt="Partner Logo">
                    <img class="h-6 md:h-10 object-contain inline-block hover-scale" src="{{ asset('assets/Honda_Logo.svg') }}"
                        alt="Partner Logo">
                    ...
                    <img class="h-6 md:h-10 object-contain inline-block hover-scale" src="{{ asset('assets/auto 2000.webp') }}"
                        alt="Partner Logo">
                    <img class="h-6 md:h-10 object-contain inline-block hover-scale" src="{{ asset('assets/Ahass logo.png') }}"
                        alt="Partner Logo">
                    <img class="h-6 md:h-10 max-w-[100px] object-contain inline-block hover-scale"
  ...
  <div class="max-w-6xl mx-auto px-4">
    <h2 class="text-4xl font-bold text-center mb-12 bg-orange-400 py-5 rounded-2xl text-white hover-scale">Berita Terbaru</h2>

    <div class="grid sm:grid-cols-2 md:grid-cols-4 gap-8">
      <!-- Card -->
      <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition flex flex-col hover-lift hover-border-orange">
        <img src="{{ asset('assets/news/kcs38.jpg') }}" alt="KCS 38" class="h-40 w-full object-cover hover-scale">
        <div class="p-5 flex flex-col flex-grow">
          <h3 class="font-semibold text-lg mb-2">KCS 38 DI PUSBIDK ARHANUD</h3>
          <p class="text-sm text-gray-600 flex-grow">
            Sebanyak 93 siswa baru SMK PGRI 3 Malang mengikuti Kegiatan Cinta Sekolah (KCS) ke-38 yang digelar di Pusdik Arhanud.
          </p>
          <a href="#" class="text-orange-500 font-medium text-sm mt-4 inline-block hover-text-white hover-bg-orange px-3 py-1 rounded transition-all">Selengkapnya</a>
        </div>
      </div>

      <!-- Card -->
      <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition flex flex-col hover-lift hover-border-orange">
        <img src="{{ asset('assets/news/lks2025.jpg') }}" alt="Juara 1 LKS" class="h-40 w-full object-cover hover-scale">
        <div class="p-5 flex flex-col flex-grow">
          <h3 class="font-semibold text-lg mb-2">JUARA 1 LKS NASIONAL 2025</h3>
          <p class="text-sm text-gray-600 flex-grow">
            SMK PGRI 3 Malang kembali meraih prestasi nasional dengan meraih medali emas dalam ajang Lomba Kompetensi Siswa (LKS) Nasional 2025 bidang Manufacturing System.
          </p>
          <a href="#" class="text-orange-500 font-medium text-sm mt-4 inline-block hover-text-white hover-bg-orange px-3 py-1 rounded transition-all">Selengkapnya</a>
        </div>
      </div>
      ...
      <!-- Card -->
      <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition flex flex-col hover-lift hover-border-orange">
        <img src="{{ asset('assets/news/gamal.jpg') }}" alt="dr. Gamal ke SKARIGA" class="h-40 w-full object-cover hover-scale">
        <div class="p-5 flex flex-col flex-grow">
          <h3 class="font-semibold text-lg mb-2">dr. Gamal ke SKARIGA</h3>
          <p class="text-sm text-gray-600 flex-grow">
            Sebanyak 80 siswa SMK PGRI 3 Malang menerima bantuan Program Indonesia Pintar dari Kementerian Pendidikan melalui dr. Gamal Albinsaid.
          </p>
          <a href="#" class="text-orange-500 font-medium text-sm mt-4 inline-block hover-text-white hover-bg-orange px-3 py-1 rounded transition-all">Selengkapnya</a>
        </div>
      </div>
      ...
      <!-- Card -->
      <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition flex flex-col hover-lift hover-border-orange">
        <img src="{{ asset('assets/news/futsal.jpg') }}" alt="School Visit" class="h-40 w-full object-cover hover-scale">
        <div class="p-5 flex flex-col flex-grow">
          <h3 class="font-semibold text-lg mb-2">School Visit oleh Futsal Series</h3>
          <p class="text-sm text-gray-600 flex-grow">
            SMK PGRI 3 Malang menjadi tuan rumah kegiatan "School Visit Futsal Series 2025" yang mempererat persaudaraan antar sekolah.
          </p>
          <a href="#" class="text-orange-500 font-medium text-sm mt-4 inline-block hover-text-white hover-bg-orange px-3 py-1 rounded transition-all">Selengkapnya</a>
        </div>
      </div>
