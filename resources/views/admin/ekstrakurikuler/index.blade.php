<x-admin-layout>
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('admin.ekskul.create') }}" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">+ Tambah Ekstrakurikuler</a>
    </div>
            ...
            <tbody>
                ...
                <tr class="border-b hover:bg-gray-50">
                    ...
                    <td class="p-3 text-center">
                        <a href="{{ route('admin.ekskul.edit', $ekskul->id) }}" class="text-blue-600 hover:underline">Edit</a> |
                        <form action="{{ route('admin.ekskul.destroy', $ekskul->id) }}" method="POST" class="inline" onsubmit="return confirm('Yakin ingin menghapus ekstrakurikuler ini?')">
                            @csrf
                            @method('DELETE')
